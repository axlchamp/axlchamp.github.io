		...
		if (markerEvent) {
			google.maps.event.addListener(
				...
				(j) => {
					...
					let button = isShowButton
						? `<div class="googlemap-InfoWindow-Button">
					...
					return function () {
						let $sidebar = $(element).find(`.googleMap-Locations-Sidebar[data-name="${i.name}"]`);
						let $container = $(element).find(".googleMap-Pagination-Container");
