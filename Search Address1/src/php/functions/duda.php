...
function refresh_token($data) {
    ...
    // checkSiteName($data->site_name);
    checkAPIEndpoint($data->api_endpoint);

    $curl = curl_init();

    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/' . $data->app_uuid . '/token/refresh',
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/' . $data->app_uuid . '/token/refresh',
        ...
        CURLOPT_POSTFIELDS => json_encode(["refreshToken" => $data->refreshToken]),
...
function create_swh($data) {
    ...
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/site/' . $data->site_name . '/sitewidehtml',
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/site/' . $data->site_name . '/sitewidehtml',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => 'POST',
        CURLOPT_POSTFIELDS => json_encode($data->body_params),
        CURLOPT_HTTPHEADER => array(
            'Content-Type: application/json',
            'X-DUDA-ACCESS-TOKEN: Bearer' . $data->authorization_code,
            "Authorization: Basic " . $GLOBALS["DUDA_API_KEY"] . "",
        ),
    ));
...
function update_swh($data) {
    ...
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/api/integrationhub/application/site/' . $data->site_name . '/sitewidehtml/' . $data->uuid,
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/site/' . $data->site_name . '/sitewidehtml/' . $data->uuid,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
...
function get_swh($data) {
    ...
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/site/' . $data->site_name . '/sitewidehtml/list',
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/site/' . $data->site_name . '/sitewidehtml/list',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        CURLOPT_FOLLOWLOCATION => true,
...
function get_owner_account_details($data) {
    // https://api.duda.co/api/integrationhub/application/site/siteAlias/account/details
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/site/' . $data->site_name . '/account/details',
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/site/' . $data->site_name . '/account/details',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        CURLOPT_FOLLOWLOCATION => true,
...
function get_site_pages($data) {
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/site/' . $data->site_name . '/pages',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        CURLOPT_FOLLOWLOCATION => true,
...
function get_manifest($data) {
    ...
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/' . $data->app_uuid,
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/' . $data->app_uuid,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        CURLOPT_FOLLOWLOCATION => true,
...
function get_Account($data) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_URL => $data->api_endpoint . '/api/accounts/' . $data->account_name,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
...
//List Collection (/sites/multiscreen/{$site_name}/collection)
//List Collection (/integrationhub/application/site/{$site_name}/collection)
function list_collection($data) {

    // checkSiteName($data->site_name);
    checkAPIEndpoint($data);
    
    $curl = curl_init();

    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . '/integrationhub/application/site/' . $data->site_name . '/collection',
        CURLOPT_URL => $data->api_endpoint . '/api/integrationhub/application/site/' . $data->site_name . '/collection',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
...
//Create Collection (/sites/multiscreen/{site_name}/collection)
function create_Collection($data)
{
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => "POST",
        CURLOPT_POSTFIELDS => json_encode($data->collection_obj),
        CURLOPT_HTTPHEADER => array(
            "Authorization: Basic " . $GLOBALS["DUDA_API_KEY"] . "",
            "Content-Type: application/json",
            'X-DUDA-ACCESS-TOKEN: Bearer' . $data->authorization_code,
...
//Update Collection (/sites/multiscreen/{site_name}/collection/{current_collection_name})
function update_Collection($data)
{
    checkSiteName($data->site_name);
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => $GLOBALS["live_endpoint"] . "/integrationhub/application/site/" . $data->site_name . "/collection/" . $data->collection_name,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
...
//Add Row Collection (/sites/multiscreen/{site_name}/collection/collection_name/row)
function add_Collection_Row($data) {

    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => $GLOBALS["live_endpoint"] . "/integrationhub/application/site/" . $data->site_name . "/collection/collection_name/row",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => "POST",
        CURLOPT_POSTFIELDS => json_encode($data->collection_rows),
        CURLOPT_HTTPHEADER => array(
            "Authorization: Basic " . $GLOBALS["DUDA_API_KEY"] . "",
            "Content-Type: application/json",
            'X-DUDA-ACCESS-TOKEN: Bearer' . $data->authorization_code,
    ...
    $response = json_decode($resp); //[{"id": "233"},{"id": "234"}]
...
//Refresh Collection ()
function refresh_Collection($data) {
    checkSiteName($data->site_name);
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => $GLOBALS["live_endpoint"] . "/integrationhub/application/site/" . $data->site_name . "/collection/" . $data->collection_name . "/revalidate",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
...
function delete_collection($data) {
    ...
    curl_setopt_array($curl, array(
        // CURLOPT_URL => $GLOBALS["live_endpoint"] . "/integrationhub/application/site/" . $data->site_name . "/collection/" . $data->collection_name,
        CURLOPT_URL => $data->api_endpoint . "/api/integrationhub/application/site/" . $data->site_name . "/collection/" . $data->collection_name,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
